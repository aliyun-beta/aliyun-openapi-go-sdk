...
package ubsmsinner // import "github.com/cxr29/aliyun-openapi-go-sdk/apis/ubsmsinner/v20150623"
...
// DescribeUserBusinessStatus version 2015-06-23
//
// required parameters:
...
//  name: _region, type: string
//  name: _scheme, type: string, optional values: http|https
func (api API) DescribeUserBusinessStatus(ServiceCode, Uid, callerBid string, optional openapi.M) (*DescribeUserBusinessStatusResponse, error) {
	args := NewParams()

	args.Query.Set("Action", "DescribeUserBusinessStatus")
	...
	result := new(DescribeUserBusinessStatusResponse)
	if err := api.Service.Do(result, args); err != nil {
		return nil, err
	}
	return result, nil
...
// DescribeUserBusinessStatusResponse represents the response of the api DescribeUserBusinessStatus.
...
// SetUserSecurityStatus version 2015-06-23
//
// required parameters:
//  name: StatusKey1, type: string
//  name: StatusValue1, type: string
...
//  name: _region, type: string
//  name: _scheme, type: string, optional values: http|https
func (api API) SetUserSecurityStatus(StatusKey1, StatusValue1, Uid string, optional openapi.M) (*SetUserSecurityStatusResponse, error) {
	args := NewParams()

	args.Query.Set("Action", "SetUserSecurityStatus")
	args.Query.Set("StatusKey1", StatusKey1)
	args.Query.Set("StatusValue1", StatusValue1)
	args.Query.Set("Uid", Uid)
	if v, ok := optional["Password"]; ok {
	...
	result := new(SetUserSecurityStatusResponse)
	if err := api.Service.Do(result, args); err != nil {
		return nil, err
	}
	return result, nil
...
// SetUserSecurityStatusResponse represents the response of the api SetUserSecurityStatus.
